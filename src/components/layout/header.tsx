      ...
      <nav className="mx-auto justify-between px-4 md:flex md:items-center md:px-8 lg:max-w-7xl">
        <div>
          <div className="flex items-center justify-between py-3 md:block md:py-5">
            <Link href="/" onClick={handleClick} className="flex items-center space-x-2 lg:hover:scale-[1.10]">
              <Image src='/logo.png' alt={siteConfig.name} className="" width={32} height={32} />
              <span className="text-2xl font-bold duration-200 text-secondary">
                {siteConfig.name}
              </span>
            </Link>
...
export function NavbarLinks({ navbar, handleClick }: NavbarLinksProps) {
  return (
    <div
