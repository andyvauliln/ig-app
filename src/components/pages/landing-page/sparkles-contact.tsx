...
export function SparklesPreview() {
    return (
        <div className="h-[25rem] w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md">
            <h1 className="text-shadow-yellow-400 md:text-4xl text-3xl lg:text-6xl font-bold text-center text-white relative z-20 mb-8">
                Contact Us
            </h1>
            <div className="w-[40rem] h-40 relative">
                ...
                <div className="absolute inset-x-20 top-0 bg-gradient-to-r from-transparent via-yellow-500 to-transparent h-px w-2/4" />
                ...
                <div className="absolute inset-x-60 top-0 bg-gradient-to-r from-transparent via-yellow-500 to-transparent h-px w-2/4" />
