            ...
            <div className="absolute -left-4 md:-left-20 top-3">
                ...
                >
                    <motion.div
                        ...
                        animate={{
                            backgroundColor:
                                scrollYProgress.get() > 0 ? "white" : "var(--gold-500)",
                            borderColor:
                                scrollYProgress.get() > 0 ? "white" : "var(--gold-600)",
                        }}
                        className="h-2 w-2  rounded-full border border-neutral-300 bg-yellow-500"
                    />
                </motion.div>
                <svg
